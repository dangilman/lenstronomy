...
class Optimizer(object):
    ...
    def __init__(self, x_pos, y_pos, redshift_list=[], lens_model_list=[], kwargs_lens=[], numerical_alpha_class = None,
                 ...
                 z_main = None, z_source=None, tol_source=1e-5, tol_image = 0.003, tol_mag=0.2, tol_centroid=0.05,
                 tol_time_delays=None, centroid_0=[0,0],
        ...
        self._optimizer = Penalties(tol_source, tol_mag, tol_centroid, lensing_class, centroid_0, magnification_target,
                                    ...
                                    verbose=verbose, chi2_mode=chi2_mode, tol_image = tol_image, tol_time_delays=tol_time_delays,
                                    solver=self.solver)
